...
void bind_TDMSingle(py::module& m)
{
    ...
    py::class_<TDMSingle, gr::sync_block, gr::block, gr::basic_block,
        ...
        .def("sampling_freq",&TDMSingle::sampling_freq,       
            D(TDMSingle,sampling_freq)
        )


        
        .def("period",&TDMSingle::period,       
            D(TDMSingle,period)
        )


        
        .def("set_sampling_freq",&TDMSingle::set_sampling_freq,       
            py::arg("sampling_freq"),
        ...
        .def("set_frequency",&TDMSingle::set_frequency,       
            py::arg("frequency"),
        ...
        .def("set_period",&TDMSingle::set_period,       
            py::arg("period"),
